...
def on_message(client, userdata, msg):
    ...
    if  msg.payload.decode() == "CANCELED": #or  msg.payload.decode() == "FINISHED":
            reset()  
...
while True:
    ...
    #----------------- INICIO ---------------------------------------   
                ...
                if Porta_Aberta_Andar1 != True and Porta_Aberta_Andar2 != True and Porta_Aberta_Andar3 != True and Iniciado == False:
                    ...
                    ## MUDA O STATUS DO INICIADO AQUI COM O RECEBIMENTO DA MENSAGEM MQTT
        ...
        #------- ALERTA INATIVIDADE -------------------------------------
                    ...
                    if  Alerta_Tempo_Inatividade == True and Analise_Disponivel == True:
                        client.publish(f"central/1", "Botijão Não Detectado!")
                        print(f"Botijão Não Detectado!")
                        time.sleep(5)
                        continue
                ...
                if  Botijao_Aceito == True and Intent == 0:     
                    ...
                    # client.publish(f"central/1", "Botijão Aceito!\nGerando cobrança\nPor favor, Aguarde........")
                    # print(f"Botijão Aceito - DISPARAR INTENCAO DE PAGAMENTO {Intent}")
                    time.sleep(3)
