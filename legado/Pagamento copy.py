...
#             status = self.path.strip("/")

#             if status == "True":
#                 Iniciado = True
#                 print(f"CLIENTE CLICOU NO BOTAO DE INICIO")
...
#                 server_address = ('0.0.0.0', 5500)  # Escuta em todas as interfaces na porta 5000
#                 httpd = HTTPServer(server_address, SimpleRequestHandler)
#                 print('Servidor iniciado em http://0.0.0.0:5500')
#                 httpd.serve_forever()                
...
while True:
    ...
    #----------------- INICIO ---------------------------------------    
                ...
                if status == "True":
                            Iniciado = True
                            print(f"CLIENTE CLICOU NO BOTAO DE INICIO {Iniciado}")
